# Generated by Django 4.2 on 2023-04-23 08:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Slug will be used in the URL. Must be unique.', max_length=255, unique=True, verbose_name='slug')),
                ('description', models.TextField(verbose_name='description')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='date created')),
                ('admins', models.ManyToManyField(related_name='admin_projects', to=settings.AUTH_USER_MODEL, verbose_name='admin')),
            ],
        ),
        migrations.CreateModel(
            name='Todolist',
